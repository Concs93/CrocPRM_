...
/*==========================================
 * Returns a character's specified total stat (base + bonus).
 * readparam2 <param>;
 *------------------------------------------*/
BUILDIN_FUNC(readparam2)
{
	...
	switch( param_type ) {
		case 0: value = sd->battle_status.str; break;   // STR total
		case 1: value = sd->battle_status.agi; break;   // AGI total
		case 2: value = sd->battle_status.vit; break;   // VIT total
		case 3: value = sd->battle_status.int_; break;  // INT total
		case 4: value = sd->battle_status.dex; break;   // DEX total
		case 5: value = sd->battle_status.luk; break;   // LUK total
		default:
			script_pushint(st, -1);
			return SCRIPT_CMD_FAILURE;
	}
